...
local function determineStationOrder()
    ...
    -- 4. Barrow-downs
    if arch_sites[arch_site] or historic_tombs[historic] or man_made_tombs[man_made] or memorials[memorial] or 
       landuse == "cemetery" or amenity == "grave_yard" or cemetery ~= "" or tomb ~= "" then
        return "4"
    end
    ...
    -- 6. Amon Sûl
    if arch_site == "fortification" or amon_sul_ruins[ruins] or (historic == "castle" and ruins == "yes") or 
       tourism == "viewpoint" or Find("tower:type") == "observation" then 
        return "6" 
    end
    ...
    -- 9. Mines of Moria
    if moria_man_made[man_made] or moria_historic[historic] or moria_natural[natural] or shelter_type == "rock_shelter" or 
